...
public class DeltaFilePattern implements FilenameFilter {
    ...
    DeltaFilePattern(FileName fullFileName, String permaName, int fullFileNumber) {
        this.fullFileName = fullFileName;
        this.pattern = Pattern.compile(String.format(DELTA_FILE_NAME_PATTERN_TEMPLATE, permaName, fullFileNumber));
    }

    public ImmutableList<FileName> parse(String[] fileNames) {
    ...
    private FileName parse(String fileName) {
